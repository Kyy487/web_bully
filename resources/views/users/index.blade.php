...
<head>
    ...
    <title>Kelola Pengguna - E-Rapor</title>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(Auth::user()->role === 'admin')
                    ...
                    <li><a href="{{ route('users.index') }}" class="active"><i class="bi bi-person-circle"></i> Pengguna</a></li>
        ...
        <div class="main-content">
            <div class="page-header">
                <div>
                    <h1><i class="bi bi-person-circle"></i> Kelola Pengguna</h1>
                    <p style="color: #999; margin-top: 5px; font-size: 14px;">Kelola semua akun pengguna sistem</p>
                </div>
            ...
            <div class="content">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <h3 style="color: #333; margin-bottom: 5px;">Belum Ada Pengguna</h3>
                        <p>Mulai dengan menambahkan pengguna baru</p>
                        <a href="{{ route('users.create') }}" class="btn" style="margin-top: 15px;">
