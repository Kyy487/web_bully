...
<head>
    ...
    <title>Tambah Pengguna - E-Rapor</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1><i class="bi bi-plus-circle"></i> Tambah Pengguna</h1>
        ...
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: John Doe" required>
                ...
                <div class="form-group">
                    ...
                    <select id="study_class_id" name="study_class_id">
                        ...
                        @foreach($classes as $class)
                            <option value="{{ $class->id }}" {{ old('study_class_id') == $class->id ? 'selected' : '' }}>
                                {{ $class->name }}
                            </option>
                        @endforeach
                    </select>
