...
<head>
    ...
    <title>Kelola Kelas - E-Rapor</title>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(Auth::user()->role === 'admin')
                    <li><a href="{{ route('classes.index') }}" class="active"><i class="bi bi-building"></i> Kelas</a></li>
        ...
        <div class="main-content">
            <div class="page-header">
                <h1><i class="bi bi-building"></i> Kelola Kelas</h1>
        ...
        <div class="content">
                    ...
                    <tbody>
                        @foreach ($classes as $class)
                            <tr>
                                ...
                                <td>{{ $class->students->count() ?? 0 }} Siswa</td>
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('classes.edit', $class->id) }}" class="btn btn-secondary">
                                            <i class="bi bi-pencil"></i> Edit
                                        </a>
                                        <form action="{{ route('classes.destroy', $class->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kelas ini?');">
                                            @csrf
                                            @method('DELETE')
            ...
            @else
                <div class="empty-state">
                    ...
                    <h3 style="color: #333; margin-bottom: 5px;">Belum Ada Kelas</h3>
                    <p>Mulai dengan menambahkan kelas baru</p>
                    <a href="{{ route('classes.create') }}" class="btn" style="margin-top: 15px;">
