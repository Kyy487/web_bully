...
<head>
    ...
    <title>Tambah Kelas - E-Rapor</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1><i class="bi bi-plus-circle"></i> Tambah Kelas</h1>
            <p>Buat kelas pembelajaran baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('classes.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: X-A atau X-IPA-1" required>
