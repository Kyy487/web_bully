...
<head>
    ...
    <title>Edit Nilai - E-Rapor</title>
    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                <h1><i class="bi bi-pencil-square"></i> Edit Nilai</h1>
            ...
            <form action="{{ route('grades.update', $grade->id) }}" method="POST">
                ...
                <div class="form-group {{ $errors->has('score') ? 'has-error' : '' }}">
                    ...
                    <input type="number" name="score" id="score" min="0" max="100" placeholder="Masukkan nilai" value="{{ $grade->score }}" required>
                    @if ($errors->has('score'))
