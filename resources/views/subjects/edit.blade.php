...
<head>
    ...
    <title>Edit Mata Pelajaran - E-Rapor</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1><i class="bi bi-pencil-square"></i> Edit Mata Pelajaran</h1>
        ...
        <form method="POST" action="{{ route('subjects.update', $subject) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $subject->name) }}" placeholder="Contoh: Matematika atau Bahasa Inggris" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" value="{{ old('code', $subject->code) }}" placeholder="Contoh: MTK atau BI">
