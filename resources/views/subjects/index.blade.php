...
<head>
    ...
    <title>Kelola Mata Pelajaran - E-Rapor</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-header { background: white; padding: 20px 30px; border-radius: 12px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06); }
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @if(Auth::user()->role === 'admin')
                    ...
                    <li><a href="{{ route('subjects.index') }}" class="active"><i class="bi bi-book"></i> Mata Pelajaran</a></li>
        ...
        <div class="main-content">
            <div class="page-header">
                <div>
                    <h1><i class="bi bi-book"></i> Kelola Mata Pelajaran</h1>
                    <p style="color: #999; margin-top: 5px; font-size: 14px;">Kelola semua mata pelajaran di sekolah</p>
                </div>
            ...
            <div class="content">
                        ...
                        <tbody>
                            @foreach ($subjects as $subject)
                                <tr>
                                    ...
                                    <td><span style="background: #f0f2ff; color: #667eea; padding: 4px 8px; border-radius: 4px; font-size: 12px;">{{ $subject->code ?? '-' }}</span></td>
                                    <td>
                                        <div class="actions">
                                            <a href="{{ route('subjects.edit', $subject->id) }}" class="btn btn-secondary">
                                                <i class="bi bi-pencil"></i> Edit
                                            </a>
                                            <form action="{{ route('subjects.destroy', $subject->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mata pelajaran ini?');">
                                                @csrf
                                                @method('DELETE')
                ...
                @else
                    <div class="empty-state">
                        ...
                        <h3 style="color: #333; margin-bottom: 5px;">Belum Ada Mata Pelajaran</h3>
                        <p>Mulai dengan menambahkan mata pelajaran baru</p>
                        <a href="{{ route('subjects.create') }}" class="btn" style="margin-top: 15px;">
