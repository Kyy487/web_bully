...
<head>
    ...
    <title>Tambah Mata Pelajaran - E-Rapor</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input { width: 100%; padding: 12px 15px; border: 2px solid #e8ecf4; border-radius: 8px; font-family: 'Poppins', sans-serif; font-size: 14px; transition: all 0.3s; }
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1><i class="bi bi-plus-circle"></i> Tambah Mata Pelajaran</h1>
            <p>Buat mata pelajaran baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('subjects.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Matematika atau Bahasa Inggris" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" value="{{ old('code') }}" placeholder="Contoh: MTK atau BI">
                @error('code') <span class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</span> @enderror
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn">
                    <i class="bi bi-check-circle"></i> Simpan Mapel
                </button>
            </div>
        </form>
    </div>
