...
<head>
    ...
    <title>Tambah Siswa - E-Rapor</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1><i class="bi bi-plus-circle"></i> Tambah Siswa</h1>
            <p>Assign siswa ke kelas dengan wali kelasnya</p>
        </div>
        ...
        <form method="POST" action="{{ route('students.store') }}">
            ...
            <div class="form-group">
                ...
                @error('user_id') <span class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</span> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select id="study_class_id" name="study_class_id" required>
                    ...
                    @foreach($classes as $class)
                        <option value="{{ $class->id }}" @selected(old('study_class_id') == $class->id)>
                            {{ $class->name }}
